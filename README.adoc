...
== Conflictos encontrados para documentar la Api con swagger:

1. Al implementar las dependencias de swagger, se dede elegir la versión más estable, la que tiene mas usuarios, las últimas versiones generan errores en la compilación:
...
2. Al descargarme el proyecto desde Spring.io, tenia la versión 2.6.3 del framework:
      
    para corregir el error del @bean, cambie la versión del framework a la versión 2.0.5
    <parent>
...
3.- Para visualizar el swagger, una vez levantado el servidor(compilación correcta) en la url: 
* http://localhost:8080/swagger-ui.html.

4.- Enlaces de referencias para resolver todos los bugs generados y guías para documentar la Api:
